...
## 二、过拟合：20阶，转换成20个特征的线性拟合，复杂度正好
x_train2 = polynomial(x_train, 20)

x_test2 = polynomial(x_test, 20)
...
ax[2].text(-3, 1, f"测试集均方误差：{test_loss2:.4f}")
ax[2].text(-3, 1.3, f"训练集均方误差：{train_loss2:.4f}")
