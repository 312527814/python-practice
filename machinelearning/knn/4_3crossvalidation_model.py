...
# 定义参数网格
param_grid = {"n_neighbors": list(range(1, 11))}  # 定义超参n_neighbors的取值范围
...
print("最佳模型:",knn.best_estimator_)  # 最佳模型
print("最佳模型得分:" , knn.best_score_)  # 最佳模型得分

# 用最佳模型做测试和预测
knn = knn.best_estimator_
print("用最佳模型做测试和预测:" , knn.score(x_test, y_test))
